...
export const isolatedTerminalProcedure = isolatedRoleProcedure(ROLES.TERMINAL_MANAGER);
export const isolatedDispatchProcedure = isolatedRoleProcedure(ROLES.DISPATCH);
export const isolatedEscortProcedure = isolatedRoleProcedure(ROLES.ESCORT);
export const isolatedFactoringProcedure = isolatedRoleProcedure(ROLES.FACTORING);
export const isolatedComplianceProcedure = isolatedRoleProcedure(ROLES.COMPLIANCE_OFFICER);
