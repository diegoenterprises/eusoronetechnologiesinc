...
export const STATE_METADATA: Record<LoadState, StateMetadata> = {
  ...
  DRAFT: {
    ...
    icon: "FileEdit", color: "#94a3b8", bgColor: "#1e293b",
  ...
  POSTED: {
    ...
    icon: "Megaphone", color: "#3b82f6", bgColor: "#1e3a5f",
  ...
  BIDDING: {
    ...
    icon: "Scale", color: "#8b5cf6", bgColor: "#2e1065",
  ...
  EXPIRED: {
    ...
    icon: "Clock", color: "#6b7280", bgColor: "#1f2937",
  ...
  AWARDED: {
    ...
    icon: "Award", color: "#f59e0b", bgColor: "#451a03",
  ...
  DECLINED: {
    ...
    icon: "XCircle", color: "#ef4444", bgColor: "#450a0a",
    primaryActor: ["SHIPPER"], allowedActors: ["SHIPPER", "BROKER", "ADMIN"],
  ...
  LAPSED: {
    ...
    icon: "Hourglass", color: "#6b7280", bgColor: "#1f2937",
    primaryActor: ["SHIPPER"], allowedActors: ["SHIPPER", "BROKER", "ADMIN"],
    gpsRequired: false, documentsRequired: [], isException: true,
  },
  ACCEPTED: {
    ...
    icon: "CheckCircle", color: "#22c55e", bgColor: "#052e16",
  ...
  ASSIGNED: {
    ...
    icon: "Truck", color: "#06b6d4", bgColor: "#083344",
  ...
  CONFIRMED: {
    ...
    icon: "ThumbsUp", color: "#10b981", bgColor: "#064e3b",
  ...
  EN_ROUTE_PICKUP: {
    ...
    icon: "Navigation", color: "#3b82f6", bgColor: "#1e3a5f",
    primaryActor: ["DRIVER"], allowedActors: ["DRIVER", "DISPATCH", "ADMIN"],
  ...
  AT_PICKUP: {
    ...
    icon: "MapPin", color: "#f59e0b", bgColor: "#451a03",
  ...
  PICKUP_CHECKIN: {
    ...
    icon: "KeyRound", color: "#8b5cf6", bgColor: "#2e1065",
  ...
  LOADING: {
    ...
    icon: "Package", color: "#f97316", bgColor: "#431407",
  ...
  LOADING_EXCEPTION: {
    ...
    icon: "AlertTriangle", color: "#ef4444", bgColor: "#450a0a",
  ...
  IN_TRANSIT: {
    ...
    icon: "Truck", color: "#3b82f6", bgColor: "#1e3a5f",
  ...
  TRANSIT_HOLD: {
    ...
    icon: "Pause", color: "#f59e0b", bgColor: "#451a03",
    primaryActor: ["DRIVER"], allowedActors: ["DRIVER", "DISPATCH", "ADMIN"],
    gpsRequired: true, documentsRequired: [],
  ...
  TRANSIT_EXCEPTION: {
    ...
    icon: "Siren", color: "#ef4444", bgColor: "#450a0a",
  ...
  AT_DELIVERY: {
    ...
    icon: "MapPin", color: "#10b981", bgColor: "#064e3b",
    primaryActor: ["DRIVER"], allowedActors: ["DRIVER", "TERMINAL_MANAGER", "DISPATCH"],
    gpsRequired: true, documentsRequired: [],
  ...
  POD_PENDING: {
    ...
    icon: "ClipboardCheck", color: "#8b5cf6", bgColor: "#2e1065",
  ...
  POD_REJECTED: {
    ...
    icon: "RefreshCw", color: "#ef4444", bgColor: "#450a0a",
    primaryActor: ["DRIVER"], allowedActors: ["DRIVER", "DISPATCH", "ADMIN"],
  ...
  DELIVERED: {
    ...
    icon: "PartyPopper", color: "#22c55e", bgColor: "#052e16",
  ...
  INVOICED: {
    ...
    icon: "FileText", color: "#06b6d4", bgColor: "#083344",
  ...
  DISPUTED: {
    ...
    icon: "Zap", color: "#ef4444", bgColor: "#450a0a",
  ...
  PAID: {
    ...
    icon: "DollarSign", color: "#22c55e", bgColor: "#052e16",
  ...
  COMPLETE: {
    ...
    icon: "Flag", color: "#10b981", bgColor: "#064e3b",
  ...
  CANCELLED: {
    ...
    icon: "Ban", color: "#6b7280", bgColor: "#1f2937",
