...
export const complianceRouter = router({
  ...
  // SAFER Lookup
  saferLookup: protectedProcedure.input(z.object({ dotNumber: z.string().optional(), mcNumber: z.string().optional(), type: z.string().optional() })).mutation(async ({ input }) => ({ dotNumber: input.dotNumber || "1234567", legalName: "ABC Transport LLC", status: "AUTHORIZED", safetyRating: "Satisfactory" })),
