...
export const scadaRouter = router({
  ...
  getAlarmHistory: protectedProcedure.input(z.object({ limit: z.number().optional(), terminalId: z.string().optional() }).optional()).query(async () => [{ id: "a1", type: "low_level", resolvedAt: "2025-01-22 15:00", severity: "warning", message: "Tank T-101 low level", source: "Tank T-101", resolved: true, timestamp: "2025-01-22T14:30:00Z" }]),
