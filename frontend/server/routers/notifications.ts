...
export const notificationsRouter = router({
  ...
  updateSetting: protectedProcedure.input(z.object({ key: z.string(), value: z.any(), setting: z.string().optional() })).mutation(async ({ input }) => ({ success: true, key: input.key || input.setting })),
