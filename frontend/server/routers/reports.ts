...
export const reportsRouter = router({
  ...
  getPerformanceMetrics: protectedProcedure.input(z.object({ period: z.string().optional() }).optional()).query(async () => ({ avgLoadTime: 2.5, totalReports: 150, mostPopular: "revenue", revenue: 125000, loads: 450, drivers: 24, avgScore: 92, loadsCompleted: 450, onTimeRate: 96.5, avgDeliveryTime: 2.5, acceptanceRate: 92, satisfaction: 4.8 })),
