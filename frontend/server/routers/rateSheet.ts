...
const TRAILER_RATE_STRUCTURES: Record<string, { mult: number; unit: string; defaultProduct: string }> = {
  ...
  "double_drop":     { mult: 0.80, unit: "per_mile", defaultProduct: "Oversized Equipment" },
  "conestoga":       { mult: 0.66, unit: "per_mile", defaultProduct: "Weather-Sensitive Freight" },
  "gas_tank":        { mult: 1.10, unit: "per_barrel", defaultProduct: "Propane" },
  "cryogenic":       { mult: 1.15, unit: "per_barrel", defaultProduct: "LNG" },
  "hazmat_van":      { mult: 0.75, unit: "per_mile", defaultProduct: "Hazmat Dry Goods" },
  "food_grade_tank": { mult: 0.90, unit: "per_barrel", defaultProduct: "Milk" },
  "water_tank":      { mult: 0.60, unit: "per_barrel", defaultProduct: "Potable Water" },
  "auto_carrier":    { mult: 0.62, unit: "per_mile", defaultProduct: "Vehicles" },
  "livestock":       { mult: 0.74, unit: "per_mile", defaultProduct: "Cattle" },
  "log_trailer":     { mult: 0.60, unit: "per_mile", defaultProduct: "Timber / Logs" },
  "grain_hopper":    { mult: 0.58, unit: "per_mile", defaultProduct: "Corn" },
  "hopper":          { mult: 0.82, unit: "per_barrel", defaultProduct: "Sand & Gravel" },
  "pneumatic":       { mult: 0.80, unit: "per_barrel", defaultProduct: "Cement" },
  "dump_trailer":    { mult: 0.56, unit: "per_mile", defaultProduct: "Sand" },
  "intermodal":      { mult: 0.50, unit: "per_mile", defaultProduct: "General Freight" },
  "curtainside":     { mult: 0.58, unit: "per_mile", defaultProduct: "Palletized Goods" },
};
