...
export const FACTORING_SCENARIOS: Scenario[] = [
  ...
  f(3, 'Factoring approves carrier', ['Application', 'Credit'], ['ok']),
  ...
  f(7, 'Factoring sets credit limit', ['Carrier', 'Limit'], ['ok']),
  ...
  f(23, 'Factoring views history', ['Carrier', 'Payments'], ['ok']),
  ...
  f(36, 'Factoring audits carrier', ['Review', 'Notes'], ['ok']),
  ...
  f(46, 'Factoring views carrier score', ['Rating', 'History'], ['ok']),
