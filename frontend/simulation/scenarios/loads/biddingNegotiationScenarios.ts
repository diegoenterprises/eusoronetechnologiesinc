...
export const BIDDING_NEGOTIATION_SCENARIOS: Scenario[] = [
  // Load Bidding (1-25)
  createBidScenario(1, 'Carrier submits bid on posted load', 'CARRIER_C001',
  ...
  createBidScenario(4, 'Bid below minimum rate rejected', 'CARRIER_C001',
  ...
  createBidScenario(26, 'Broker initiates negotiation', 'BROKER_B001',
    ['Receive bid $2500', 'Counter offer $2300', 'Message included', 'Carrier notified'],
    ['counter_sent', 'carrier_notified']),
  createBidScenario(27, 'Carrier counter-offers', 'CARRIER_C001',
  ...
  createBidScenario(30, 'Accept negotiated rate', 'CARRIER_C001',
  ...
  createBidScenario(32, 'Negotiation with attachments', 'CARRIER_C001',
  ...
  createBidScenario(35, 'Market rate comparison during negotiation', 'CARRIER_C001',
  ...
  createBidScenario(38, 'Negotiation notification batching', 'CARRIER_C002',
    ['Multiple negotiations', 'Batch notifications', 'Digest format'],
    ['batching_works', 'digest_sent']),
  createBidScenario(39, 'Mobile negotiation interface', 'CARRIER_C001',
  ...
  createBidScenario(52, 'Digital signature on rate con', 'CARRIER_C001',
  ...
  createBidScenario(57, 'Spot rate vs contract rate display', 'CARRIER_C001',
  ...
  createBidScenario(66, 'Bid on load already booked', 'CARRIER_C001',
  ...
  createBidScenario(67, 'Negotiation with offline party', 'BROKER_B001',
    ['Send counter', 'Carrier offline', 'Message queued', 'Delivered when online'],
    ['queue_works', 'delivery_on_reconnect']),
  createBidScenario(68, 'Concurrent negotiations same load', 'BROKER_B001',
    ['Multiple carriers negotiating', 'First to accept wins', 'Others notified'],
  ...
  createBidScenario(71, 'High-value load requires additional verification', 'SYSTEM',
    ['Load value > $100k', 'Additional carrier vetting', 'Insurance verified', 'Proceed'],
  ...
  createBidScenario(75, 'Bidding performance analytics', 'CARRIER_C002',
