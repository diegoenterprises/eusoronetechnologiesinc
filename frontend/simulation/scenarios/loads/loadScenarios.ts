...
export const LOAD_MANAGEMENT_SCENARIOS: Scenario[] = [
  ...
  createLoadScenario(2, 'Broker posts refrigerated load with temp requirements', 'BROKER_B003',
    ['Create reefer load', 'Set temp: 34°F', 'Add continuous monitoring', 'Post load'],
  ...
  createLoadScenario(62, 'Carrier assigns driver to load', 'CARRIER_C002',
    ['Book load as carrier', 'Assign driver', 'Driver notified'],
  ...
  createLoadScenario(68, 'Broker assigns carrier to load', 'BROKER_B002',
    ['Select load', 'Assign to trusted carrier', 'Carrier accepts'],
    ['assignment_works', 'carrier_notified']),
  ...
  createLoadScenario(127, 'Load history available for reporting', 'CARRIER_C002',
  ...
  createLoadScenario(143, 'Broker load matching automation', 'BROKER_B005',
    ['New load posted', 'Auto-matched to carrier', 'Carrier notified'],
    ['auto_matching']),
  ...
  createLoadScenario(146, 'Load API integration', 'EXTERNAL_SYSTEM',
    ...
    ['api_works']),
  createLoadScenario(147, 'Archived load retrieval', 'CARRIER_C002',
