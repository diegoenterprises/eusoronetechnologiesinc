...
export const BROKER_SCENARIOS: Scenario[] = [
  ...
  b(7, 'Broker views carrier list', ['Approved', 'Stats'], ['ok']),
  b(8, 'Broker vets carrier', ['SAFER', 'Insurance'], ['ok']),
  b(9, 'Broker approves carrier', ['Review', 'Approve'], ['ok']),
  ...
  b(22, 'Broker contacts carrier', ['Message', 'Call'], ['ok']),
  ...
  b(43, 'Broker views carrier ratings', ['Score', 'History'], ['ok']),
  b(44, 'Broker rates carrier', ['Stars', 'Comment'], ['ok']),
