...
export const AGENT_SCENARIOS: Scenario[] = [
  ...
  a(3, 'Agent matches carrier', ['Load', 'Carrier'], ['ok']),
  ...
  a(8, 'Agent contacts carrier', ['Message', 'Send'], ['ok']),
  ...
  a(21, 'Agent views carrier pool', ['Approved', 'Stats'], ['ok']),
  a(22, 'Agent vets carrier', ['Check', 'Approve'], ['ok']),
