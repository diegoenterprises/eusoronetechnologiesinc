...
export const MESSAGING_SCENARIOS: Scenario[] = [
  ...
  createMessagingScenario(26, 'Create group chat', 'CATALYST_C002',
    ['Create group', 'Add drivers', 'Set group name', 'Group created'],
    ['group_created']),
  createMessagingScenario(27, 'Add member to group', 'CATALYST_C002',
    ['Open group settings', 'Add new member', 'Member notified'],
    ['member_added']),
  createMessagingScenario(28, 'Remove member from group', 'CATALYST_C002',
  ...
  createMessagingScenario(29, 'Leave group', 'DRIVER_D003',
    ...
    ['leave_works']),
  createMessagingScenario(30, 'Group admin permissions', 'CATALYST_C002',
  ...
  createMessagingScenario(31, '@mention in group', 'DRIVER_D003',
    ...
    ['mention_works']),
  createMessagingScenario(32, 'Group announcement', 'CATALYST_C002',
  ...
  createMessagingScenario(33, 'Mute group notifications', 'DRIVER_D005',
    ...
    ['mute_works']),
  createMessagingScenario(34, 'Group message read status', 'CATALYST_C002',
    ['Send to group', 'See who read', 'Delivery/read counts'],
    ['read_status_works']),
  createMessagingScenario(35, 'Delete group', 'CATALYST_C002',
