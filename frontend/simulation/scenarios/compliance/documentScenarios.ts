...
export const DOCUMENT_COMPLIANCE_SCENARIOS: Scenario[] = [
  ...
  createDocScenario(26, 'Catalyst uploads liability insurance COI', 'CATALYST_C002',
  ...
  createDocScenario(28, 'Cargo insurance verification', 'CATALYST_C001',
  ...
  createDocScenario(29, 'Insurance expiration auto-notification', 'SYSTEM',
    ['Insurance expires in 14 days', 'Auto-email to catalyst', 'Broker notified', 'Renewal reminder'],
    ['auto_notification', 'broker_notified']),
  createDocScenario(30, 'Insurance certificate sharing with shipper', 'CATALYST_C002',
  ...
  createDocScenario(73, 'Run ticket IFTA reporting', 'CATALYST_C002',
    ['Quarterly IFTA due', 'Aggregate fuel by state', 'Miles by state', 'Report generated'],
    ['ifta_aggregated', 'report_generated']),
  createDocScenario(74, 'Run ticket history by driver', 'CATALYST_C002',
