...
export const SHIPPER_SCENARIOS: Scenario[] = [
  ...
  s(9, 'Shipper rates catalyst', ['Stars', 'Comment'], ['ok']),
  ...
  s(15, 'Shipper views catalyst list', ['Approved', 'Stats'], ['ok']),
  s(16, 'Shipper adds preferred catalyst', ['Search', 'Add'], ['ok']),
  ...
  s(30, 'Shipper contacts catalyst', ['Message', 'Send'], ['ok']),
