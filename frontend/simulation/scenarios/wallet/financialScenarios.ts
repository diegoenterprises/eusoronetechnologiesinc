...
export const WALLET_FINANCIAL_SCENARIOS: Scenario[] = [
  ...
  createWalletScenario(3, 'Catalyst pays driver settlement', 'CATALYST_C002',
    ['Login as catalyst', 'Process settlement', 'Apply deductions', 'Verify net pay'],
    ['deductions_correct', 'pay_stub_generated']),
  createWalletScenario(4, 'Broker pays catalyst for load', 'BROKER_B001',
  ...
  createWalletScenario(7, 'Recurring scheduled transfer', 'CATALYST_C002',
  ...
  createWalletScenario(27, 'QuickPay auto-approval for trusted catalysts', 'BROKER_B005',
    ['Configure auto-approval', 'Catalyst requests QuickPay', 'Instant approval'],
    ['auto_approve_works']),
  ...
  createWalletScenario(84, 'Escrow timeout auto-release', 'SYSTEM',
    ['No action after 7 days', 'Auto-release to catalyst'],
    ['timeout_works', 'auto_release']),
  createWalletScenario(85, 'Invoice generation', 'CATALYST_C002',
  ...
  createWalletScenario(88, 'Factoring integration', 'CATALYST_C001',
  ...
  createWalletScenario(96, 'Wallet analytics dashboard', 'CATALYST_C002',
    ['View spending trends', 'Income vs expenses chart'],
    ['analytics_displayed', 'charts_accurate']),
  createWalletScenario(97, 'Automated payment rules', 'CATALYST_C003',
