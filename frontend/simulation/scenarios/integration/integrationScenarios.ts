...
export const INTEGRATION_SCENARIOS: Scenario[] = [
  ...
  createIntegrationScenario(1, 'Complete load lifecycle: post to payment', 'FULL_FLOW',
    ['Shipper posts load', 'Broker finds catalyst', 'Driver assigned', 'Pickup completed', 'Delivery completed', 'POD uploaded', 'Invoice generated', 'Payment processed'],
  ...
  createIntegrationScenario(3, 'Catalyst fleet onboarding', 'CATALYST_C009',
    ['Create catalyst account', 'Add authority', 'Add insurance', 'Add 5 drivers', 'Verify all', 'Book first load'],
  ...
  createIntegrationScenario(8, 'Dispute resolution workflow', 'DRIVER_D003',
    ...
    ['dispute_resolved']),
  createIntegrationScenario(9, 'Factoring company integration', 'CATALYST_C001',
  ...
  createIntegrationScenario(10, 'Rating and review cycle', 'FULL_FLOW',
    ['Load completed', 'Driver rates shipper', 'Shipper rates driver', 'Broker rates catalyst', 'All ratings visible'],
  ...
  createIntegrationScenario(29, 'Telemetry feeds into safety score', 'DRIVER_D003',
    ['Drive with ELD', 'Events recorded', 'Safety score updates', 'Catalyst sees score'],
    ['telemetry_to_safety']),
  ...
  createIntegrationScenario(52, 'TMS integration - status export', 'SYSTEM',
    ...
    ['tms_export_works']),
  createIntegrationScenario(53, 'ELD provider integration', 'CATALYST_C002',
  ...
  createIntegrationScenario(60, 'FMCSA SAFER API', 'SYSTEM',
    ['Check catalyst', 'API returns data', 'Authority verified'],
    ['fmcsa_api_works']),
