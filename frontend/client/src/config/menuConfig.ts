...
export const SHARED_FOOTER_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { icon: "Receipt", label: "Accessorials", path: "/detention-accessorials", badge: 0, description: "Detention, lumper, TONU fees" },
      { icon: "Sparkles", label: "Smart Pricing", path: "/predictive-pricing", badge: 0, description: "AI-powered rate predictions, dynamic pricing & demand forecasts" },
  ...
  CATALYST: [
    ...
    },
    {
      ...
      children: [
        ...
        { icon: "Shield", label: "Compliance Monitoring", path: "/compliance-rules", badge: 0, description: "FMCSA compliance status & regulatory monitoring" },
  ...
  BROKER: [
    ...
    { icon: "Newspaper", label: "News", path: "/news", badge: 0, description: "Platform news and updates" },
    {
      ...
      children: [
        ...
        { icon: "Factory", label: "Industry Verticals", path: "/industry-verticals", badge: 0, description: "Vertical-specific workflows for petroleum, pharma, agriculture & more" },
        { icon: "Ship", label: "Multi-Modal Transport", path: "/multi-modal", badge: 0, description: "Intermodal shipping — truck, rail, ocean & air coordination" },
        { icon: "Briefcase", label: "Partner Brokers", path: "/broker-management", badge: 0, description: "Manage broker partnerships and referrals" },
      ],
    },
  ],
  ...
  DRIVER: [
    ...
    },
    {
      ...
      children: [
        ...
        { icon: "Activity", label: "ELD Status", path: "/eld", badge: 0, description: "Your ELD device status, HOS clocks & driving compliance" },
      ],
    },
    {
      icon: "Shield",
      ...
      children: [
        ...
        { icon: "BadgeCheck", label: "My Licenses & Endorsements", path: "/driver/licenses", badge: 0, description: "CDL, hazmat endorsement, TWIC & certification status" },
        { icon: "GraduationCap", label: "Training", path: "/training-compliance", badge: 0, description: "Training programs, certifications & compliance coursework" },
      ],
    },
    {
