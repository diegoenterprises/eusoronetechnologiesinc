    ...
    <div className="flex h-screen bg-slate-950 text-white relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative z-10">
        ...
        <motion.header
          ...
          className={`backdrop-blur-xl px-3 sm:px-6 py-3 flex items-center justify-between relative z-20 ${theme === "light" ? "bg-white/80 border-b border-slate-200/60" : "bg-slate-950/80 border-b border-white/[0.04]"}`}
        >
