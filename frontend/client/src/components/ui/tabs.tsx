...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "inline-flex h-10 w-fit items-center justify-center rounded-xl bg-white/[0.04] border border-white/[0.06] p-1 gap-0.5",
        className
      )}
      {...props}
    />
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:bg-white/[0.08] data-[state=active]:text-white data-[state=active]:border-white/[0.08] data-[state=active]:shadow-sm",
        className
      )}
      {...props}
    />
