...
export default function ShipperAutoPay() {
  ...
  const dataQuery = (trpc as any).shipper.getAutoPay.useQuery();
    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Configure auto-payment</p>
        </div>
