...
export default function FactoringCarriers() {
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Manage approved carriers and credit limits</p>
      </div>
      ...
      {customersQuery.isLoading ? (
        ...
        <Card className="border-border/50 bg-card/50">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-lg font-medium">No carriers in portfolio</p>
            <p className="text-sm text-muted-foreground">Approved carriers will appear here after credit check</p>
          </CardContent>
        </Card>
      ) : (
            ...
            <Card key={i} className="border-border/50 bg-card/50 hover:border-[#1473FF]/30 transition-all">
              <CardContent className="p-4 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium">{c.name || "Carrier"}</p>
