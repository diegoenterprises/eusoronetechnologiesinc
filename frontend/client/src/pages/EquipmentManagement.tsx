...
import {
  ...
  CheckCircle, AlertTriangle, Clock, Eye, Upload
} from "lucide-react";
...
export default function EquipmentManagement() {
  ...
  const equipmentQuery = (trpc as any).vehicles.list.useQuery({ status: activeTab === "all" ? undefined : activeTab, limit: 50 });
  const summaryQuery = (trpc as any).vehicles.getSummary.useQuery();
  ...
  const filteredEquipment = (equipmentQuery.data as any)?.filter((eq: any) =>
    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" size="sm" onClick={() => setLocation("/bulk-upload?type=vehicles")} className="gap-1.5">
