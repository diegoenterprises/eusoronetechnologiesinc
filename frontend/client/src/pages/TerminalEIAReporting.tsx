...
export default function TerminalEIAReporting() {
  ...
  const reportQuery = trpc.terminal.getEIAReport.useQuery({ period: reportPeriod, week: selectedWeek });
  const historyQuery = trpc.terminal.getEIAHistory.useQuery();
  const inventoryQuery = trpc.terminal.getCurrentInventory.useQuery();
