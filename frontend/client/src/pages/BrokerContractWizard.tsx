          ...
          <Card className={cc}><CardHeader className="pb-3"><CardTitle className={cn("flex items-center gap-2", tc)}><Calendar className="w-5 h-5 text-blue-500" />Contract Terms</CardTitle></CardHeader>
            <CardContent className="space-y-3">
              ...
              <div><label className={lb}>Equipment</label>
                <div className="flex flex-wrap gap-2">{["dry_van", "reefer", "flatbed", "step_deck", "lowboy", "double_drop", "conestoga", "liquid_tank", "gas_tank", "cryogenic", "hazmat_van", "food_grade_tank", "water_tank", "auto_carrier", "livestock", "log_trailer", "grain_hopper", "bulk_hopper", "pneumatic", "dump_trailer", "intermodal", "curtainside"].map(eq => (
