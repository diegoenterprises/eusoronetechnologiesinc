...
export default function SuperAdminMaintenanceMode() {
  ...
  const dataQuery = (trpc as any).superAdmin.getMaintenanceMode.useQuery();
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="relative">
        ...
        <input
          type="text"
          placeholder="Search maintenance mode..."
          value={searchQuery}
