...
export default function RegisterDriver() {
  ...
  const handleComplete = async () => {
    await registerMutation.mutateAsync({
      ...
      catalystUsdot: formData.catalystUsdot || undefined,
      catalystName: formData.catalystName || undefined,
      ...
      cdlRestrictions: formData.restrictions?.length ? formData.restrictions : undefined,
      ...
      doublesTriples: formData.endorsements?.includes("T") || false,
      twicCard: !!formData.twicNumber,
      twicNumber: formData.twicNumber || undefined,
      twicExpiration: formData.twicExpiration || undefined,
      medicalCardNumber: formData.medicalCardNumber || undefined,
