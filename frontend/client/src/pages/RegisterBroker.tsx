...
export default function RegisterBroker() {
  ...
  const handleComplete = async () => {
    await registerMutation.mutateAsync({
      ...
      brokerAuthority: formData.brokerAuthority || undefined,
  ...
  const steps: WizardStep[] = [
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <DatePicker value={formData.bondExpiration} onChange={(v) => updateFormData({ bondExpiration: v })} />
            </div>
          </div>
    ...
    },
    {
      id: "payments",
      title: "Payment Setup",
      description: "How you'll manage payments on EusoTrip",
