          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <p className="text-2xl font-bold text-yellow-600">{(myRank as any).totalMiles?.toLocaleString() || 0}</p>
              </div>
              <div className="flex items-center gap-2">
                {getTrendIcon((myRank as any).change || 0)}
                <span className={(myRank as any).change > 0 ? 'text-green-600' : (myRank as any).change < 0 ? 'text-red-600' : 'text-muted-foreground'}>
                  {(myRank as any).change > 0 ? '+' : ''}{(myRank as any).change || 0} positions
                </span>
              </div>
            </div>
          </CardContent>
          ...
          <Card>
            <CardContent className="p-0">
              <div className="divide-y">
                ...
                {(!leaderboard || (leaderboard as any).leaders?.length === 0) && (
