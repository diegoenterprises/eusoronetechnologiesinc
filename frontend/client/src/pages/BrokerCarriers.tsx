    ...
    <div className="p-4 md:p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Manage your carrier relationships and vetting</p>
        </div>
        ...
        <CardContent>
          {carriersQuery.isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-slate-500 text-sm">Add carriers to build your network</p>
            </div>
          ) : (
            <div className="space-y-3">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        <span className="text-white font-medium text-lg">{carrier.name}</span>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-3">
                        <div>
                          ...
                          <p className="text-sm text-white">{carrier.mcNumber}</p>
                        </div>
                        <div>
                          <p className="text-xs text-slate-500">DOT Number</p>
                          <p className="text-sm text-white">{carrier.dotNumber}</p>
                        </div>
                        <div>
                          <p className="text-xs text-slate-500">Fleet Size</p>
                          <p className="text-sm text-white">{carrier.fleetSize} trucks</p>
                        </div>
                        <div>
                          <p className="text-xs text-slate-500">Loads Completed</p>
                          <p className="text-sm text-white">{carrier.loadsCompleted}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-4 mb-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm text-slate-300">Safety: {carrier.safetyScore}%</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Star className="w-4 h-4 text-yellow-400" />
                          <span className="text-sm text-slate-300">Rating: {carrier.rating}/5</span>
                        </div>
                      </div>
