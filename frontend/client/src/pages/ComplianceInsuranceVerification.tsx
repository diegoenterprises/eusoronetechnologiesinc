/**
 * COMPLIANCEINSURANCEVERIFICATION
 * Verify insurance
...
export default function ComplianceInsuranceVerification() {
  ...
  const dataQuery = (trpc as any).compliance.getInsuranceVerification.useQuery();
