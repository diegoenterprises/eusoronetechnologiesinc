...
export default function IntegrationTestingTools() {
  ...
  const dataQuery = (trpc as any).integrations.getTestingTools.useQuery();
    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Testing tools</p>
        </div>
      ...
      <div className="relative">
        ...
        <input
          type="text"
          placeholder="Search testing tools..."
          value={searchQuery}
