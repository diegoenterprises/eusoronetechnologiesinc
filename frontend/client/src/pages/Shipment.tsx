    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400">Manage and track all shipments with real-time analytics</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <Card className="bg-gradient-to-br from-orange-900/20 to-orange-900/10 border-orange-700 p-4">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-gray-400 text-sm">Extended Shipments</span>
          </div>
        ...
        <Card className="bg-gradient-to-br from-cyan-900/20 to-cyan-900/10 border-cyan-700 p-4">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-gray-400 text-sm">Refrigerated Shipments</span>
          </div>
        ...
        <Card className="bg-gradient-to-br from-red-900/20 to-red-900/10 border-red-700 p-4">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-gray-400 text-sm">HazMat Shipments</span>
          </div>
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-gray-400 capitalize">{shipment.type}</span>
                    </div>
                  </div>
      ...
      {filteredShipments.length === 0 && (
        <Card className="bg-slate-800 border-slate-700 p-8 text-center">
          <Truck size={32} className="mx-auto text-gray-500 mb-4" />
          <p className="text-gray-400">No shipments found for the selected filter.</p>
        </Card>
      )}
    </div>
  );
