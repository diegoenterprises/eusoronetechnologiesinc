  ...
  return (
    <div className="p-4 md:p-6 space-y-6 max-w-[1100px] mx-auto">
      ...
      <Card className={cc}>
        ...
        <CardContent>
          <Textarea value={notes} onChange={(e: any) => setNotes(e.target.value)} placeholder="Shell thickness readings, compartment details, or deficiency notes..." className={cn("rounded-xl min-h-[80px]", isLight ? "bg-white border-slate-200" : "bg-white/[0.02] border-white/[0.06] text-white placeholder:text-slate-400")} />
        </CardContent>
      </Card>
