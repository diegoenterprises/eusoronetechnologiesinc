...
export default function TelemetryDeviceManagement() {
  ...
  const dataQuery = (trpc as any).telemetry.getDeviceManagement.useQuery();
  const data = dataQuery.data;

  // tRPC Mutations
  const createMutation = (trpc as any).telemetry.create.useMutation({
    onSuccess: () => {
  ...
  const updateMutation = (trpc as any).telemetry.update.useMutation({
    onSuccess: () => {
  ...
  const deleteMutation = (trpc as any).telemetry.delete.useMutation({
    onSuccess: () => {
    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Device management</p>
        </div>
        <div className="flex gap-2">
          ...
          <Button 
            className="bg-gradient-to-r from-cyan-600 to-blue-600 rounded-lg"
        ...
        <CardContent>
          {items.length === 0 ? (
            <div className="text-center py-12">
              ...
              <Button 
                className="mt-4 bg-gradient-to-r from-cyan-600 to-blue-600 rounded-lg"
              ...
              {items
                ...
                .map((item: any, idx: number) => (
                  <div
                    ...
                    onClick={() => setLocation(`/telemetry/${item.id}`)}
                  >
                    <div className="flex items-center gap-4">
