            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 uppercase">Receivable</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 uppercase">Payable</p>
                </div>
              </div>
            </CardContent>
          </Card>
                ...
                {receivables.map((r: any) => (
                  <div key={r.id} className="p-3 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Badge className={cn("text-xs", STATUS_COLORS[r.status] || "bg-slate-500/20 text-slate-400")}>{r.status}</Badge>
                    </div>
                  </div>
                ))}
              </div>
                ...
                {payables.map((p: any) => (
                  <div key={p.id} className="p-3 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Badge className={cn("text-xs", STATUS_COLORS[p.status] || "bg-slate-500/20 text-slate-400")}>{p.status}</Badge>
                    </div>
                  </div>
                ))}
              </div>
