...
export default function SafetyIncidentCreate() {
  ...
  const dataQuery = (trpc as any).safety.getReportIncident.useQuery();
    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Create incident report</p>
        </div>
      ...
      <div className="relative">
        ...
        <input
          type="text"
          placeholder="Search report incident..."
          value={searchQuery}
