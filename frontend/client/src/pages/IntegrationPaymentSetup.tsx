...
export default function IntegrationPaymentSetup() {
  ...
  const dataQuery = (trpc as any).integrations.getPaymentSetup.useQuery();
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="relative">
        ...
        <input
          type="text"
          placeholder="Search payment setup..."
          value={searchQuery}
