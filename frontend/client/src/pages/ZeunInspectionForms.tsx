...
export default function ZeunInspectionForms() {
  ...
  const dataQuery = (trpc as any).maintenance.getInspectionForms.useQuery();
      ...
      <Card className="bg-slate-800/50 border-slate-700/50 rounded-xl">
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <CardTitle className="text-white text-lg">Inspection Forms</CardTitle>
            <div className="flex gap-2">
              <Button 
                size="sm" 
                variant="ghost" 
