...
export default function ReportBuilder() {
  ...
  const reportsQuery = trpc.reports.getSavedReports.useQuery({ search });
  const statsQuery = trpc.reports.getReportStats.useQuery();
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold bg-gradient-to-r from-cyan-400 to-emerald-400 bg-clip-text text-transparent">Report Builder</h1>
