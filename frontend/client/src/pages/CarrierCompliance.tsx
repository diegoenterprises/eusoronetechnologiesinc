...
export default function CarrierCompliance() {
  ...
  const requirementsQuery = (trpc as any).compliance?.getDocumentRequirements?.useQuery?.({ userType: "carrier" }) || { data: null, isLoading: false };
  ...
  const handleUpload = () => {
    ...
    uploadMutation.mutate({ documentType: selectedType, expirationDate: expirationDate || undefined, userType: "carrier" });
  };
