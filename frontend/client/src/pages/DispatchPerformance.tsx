...
export default function DispatchPerformance() {
  ...
  const historyQuery = (trpc as any).dispatchRole.getPerformanceHistory.useQuery({ limit: 10 });
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold bg-gradient-to-r from-[#1473FF] to-[#BE01FF] bg-clip-text text-transparent">Performance</h1>
