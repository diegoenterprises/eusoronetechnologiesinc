...
export default function MedicalCertifications() {
  ...
  const certsQuery = (trpc as any).compliance.getMedicalCerts.useQuery({ search });
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold bg-gradient-to-r from-[#1473FF] to-[#BE01FF] bg-clip-text text-transparent">Medical Certifications</h1>
      ...
      <div className="relative max-w-sm">
        ...
        <Input value={search} onChange={(e: any) => setSearch(e.target.value)} placeholder="Search certifications..." className="pl-9 bg-slate-800/50 border-slate-700/50 rounded-lg" />
      </div>
