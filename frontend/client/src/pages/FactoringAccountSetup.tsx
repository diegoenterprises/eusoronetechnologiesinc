...
export default function FactoringAccountSetup() {
  ...
  const dataQuery = (trpc as any).factoring.getAccountSetup.useQuery();
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="relative">
        ...
        <input
          type="text"
          placeholder="Search account setup..."
          value={searchQuery}
      ...
      <Card className="bg-slate-800/50 border-slate-700/50 rounded-xl">
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <CardTitle className="text-white text-lg">Account Setup</CardTitle>
            <div className="flex gap-2">
              <Button 
                size="sm" 
                variant="ghost" 
