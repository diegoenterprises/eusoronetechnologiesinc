...
export default function DVIRManagement() {
  ...
  const dvirsQuery = trpc.fleet.getDVIRs.useQuery({ filter });
  const statsQuery = trpc.fleet.getDVIRStats.useQuery();
