...
export default function CompanyManagement() {
  ...
  const companiesQuery = trpc.admin.getCompanies.useQuery({ search, type: typeFilter });
  const statsQuery = trpc.admin.getCompanyStats.useQuery();
    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="flex items-center gap-4">
        <div className="relative flex-1 max-w-sm">
          ...
          <Input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Search companies..." className="pl-9 bg-slate-800/50 border-slate-700/50 rounded-lg" />
        </div>
