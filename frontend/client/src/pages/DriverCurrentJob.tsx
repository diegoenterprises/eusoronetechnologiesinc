            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <p className="text-white font-medium">{job.quantity?.toLocaleString()} {job.quantityUnit}</p>
                </div>
                <div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="p-4 rounded-lg bg-slate-700/30 border border-slate-600/30">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-white font-medium">{job.milesCompleted} / {job.totalMiles} miles</span>
                </div>
                <Progress 
                  value={(job.milesCompleted / job.totalMiles) * 100} 
