    ...
    content: (
      <div className="space-y-3">
        ...
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li><strong className="text-white">Catalysts:</strong> USDOT number, MC/MX authority, operating authority, FMCSA safety rating, insurance ($1M+ liability, cargo coverage), BOC-3 filing</li>
    ...
    content: (
      <div className="space-y-3">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li><strong className="text-white">(d)</strong> Use information obtained through the Platform (including but not limited to shipper identities, catalyst capacities, load origins/destinations, rate information, lane data, or driver availability) to conduct off-platform transactions;</li>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-3">
        ...
        <ul className="list-disc pl-6 space-y-1">
          <li>Federal Motor Catalyst Safety Act and FMCSRs (49 CFR Parts 350-399)</li>
        ...
        <p><strong className="text-white">7.2 Insurance Requirements.</strong> All Catalysts and Drivers must maintain minimum insurance coverage as required by 49 CFR Part 387 and as specified during registration. Proof of insurance must be kept current on the Platform. Lapse of insurance results in automatic account suspension.</p>
