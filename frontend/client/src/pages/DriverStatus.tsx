...
export default function DriverStatus() {
  ...
  const driversQuery = trpc.dispatch.getDriverStatuses.useQuery({ filter, search }, { refetchInterval: 30000 });
  const statsQuery = trpc.dispatch.getDriverStatusStats.useQuery();
