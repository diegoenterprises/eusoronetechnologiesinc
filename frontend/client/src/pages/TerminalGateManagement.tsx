...
export default function TerminalGateManagement() {
  ...
  const gatesQuery = (trpc as any).terminals.getBays.useQuery();
  const transactionsQuery = (trpc as any).terminals.getAppointments.useQuery({});
  const statsQuery = (trpc as any).terminals.getStats.useQuery();

  const processEntryMutation = (trpc as any).terminals.createAppointment.useMutation({
    onSuccess: () => {
  ...
  const processExitMutation = (trpc as any).terminals.createAppointment.useMutation({
    onSuccess: () => {
