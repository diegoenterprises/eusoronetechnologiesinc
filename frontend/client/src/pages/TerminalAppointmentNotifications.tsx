/**
 * TERMINALAPPOINTMENTNOTIFICATIONS
 * Notifications
...
export default function TerminalAppointmentNotifications() {
  ...
  const dataQuery = (trpc as any).terminal.getAppointmentNotifications.useQuery();
  const data = dataQuery.data;

  // tRPC Mutations
  const createMutation = (trpc as any).terminal.create.useMutation({
    onSuccess: () => {
  ...
  const updateMutation = (trpc as any).terminal.update.useMutation({
    onSuccess: () => {
  ...
  const deleteMutation = (trpc as any).terminal.delete.useMutation({
    onSuccess: () => {
    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Notifications</p>
        </div>
        <div className="flex gap-2">
          ...
          <Button 
            className="bg-gradient-to-r from-cyan-600 to-teal-600 rounded-lg"
      ...
      <div className="relative">
        ...
        <input
          type="text"
          placeholder="Search appointment notifications..."
          value={searchQuery}
      ...
      <Card className="bg-slate-800/50 border-slate-700/50 rounded-xl">
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <CardTitle className="text-white text-lg">Appointment Notifications</CardTitle>
            <div className="flex gap-2">
              <Button 
                size="sm" 
                variant="ghost" 
        ...
        <CardContent>
          {items.length === 0 ? (
            <div className="text-center py-12">
              ...
              <Button 
                className="mt-4 bg-gradient-to-r from-cyan-600 to-teal-600 rounded-lg"
              ...
              {items
                ...
                .map((item: any, idx: number) => (
                  <div
                    ...
                    onClick={() => setLocation(`/terminal/${item.id}`)}
                  >
                    <div className="flex items-center gap-4">
