...
export default function ComplianceMROResults() {
  ...
  const dataQuery = (trpc as any).compliance.getMroResults.useQuery();
    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">MRO result review</p>
        </div>
      ...
      <div className="relative">
        ...
        <input
          type="text"
          placeholder="Search mro results..."
          value={searchQuery}
      ...
      <Card className="bg-slate-800/50 border-slate-700/50 rounded-xl">
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <CardTitle className="text-white text-lg">MRO Results</CardTitle>
            <div className="flex gap-2">
              <Button 
                size="sm" 
                variant="ghost" 
