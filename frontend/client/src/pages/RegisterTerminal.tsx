...
export default function RegisterTerminal() {
  ...
  const handleComplete = async () => {
    await registerMutation.mutateAsync({
      ...
      statePermitNumber: formData.statePermitNumber || undefined,
      spccPlanDate: formData.spccPlanDate || undefined,
      hasSpccPlan: !!formData.spccPlanDate,
      storageCapacity: formData.storageCapacity || undefined,
      eiaReporting: formData.eiaReporting || false,
      operatingHours: formData.operatingHours || undefined,
      productsHandled: formData.productsHandled?.length ? formData.productsHandled : undefined,
      loadingRacks: formData.loadingRacks || undefined,
      unloadingRacks: formData.unloadingRacks || undefined,
      hasScada: formData.hasScada || false,
