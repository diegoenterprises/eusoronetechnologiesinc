...
export default function TheHaulLeaderboards() {
  ...
  const dataQuery = (trpc as any).gamification.getLeaderboards.useQuery();
      ...
      <Card className="bg-slate-800/50 border-slate-700/50 rounded-xl">
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <CardTitle className="text-white text-lg">Leaderboards</CardTitle>
            <div className="flex gap-2">
              <Button 
                size="sm" 
                variant="ghost" 
