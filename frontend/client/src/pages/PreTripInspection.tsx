/**
 * @deprecated — consolidated into driver/VehicleInspection.tsx (Inspection History tab). Remove after migration verification.
...
export default function PreTripInspection() {
  ...
  const submitMutation = (trpc as any).inspections.submit.useMutation({
    onSuccess: () => { toast.success("Inspection submitted"); setLocation("/"); },
