...
export default function CatalystProfile() {
  const profileQuery = (trpc as any).catalysts.getProfile.useQuery();
  const statsQuery = (trpc as any).catalysts.getStats.useQuery();
  const fleetQuery = (trpc as any).catalysts.getFleetSummary.useQuery();
  const safetyQuery = (trpc as any).catalysts.getSafetyRating.useQuery();
