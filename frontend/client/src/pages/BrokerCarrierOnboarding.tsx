...
export default function BrokerCarrierOnboarding() {
  ...
  const carriersQuery = (trpc as any).brokers.getOnboardingCarriers.useQuery({ status: statusFilter });
  const statsQuery = (trpc as any).brokers.getOnboardingStats.useQuery();
  ...
  const sendReminderMutation = (trpc as any).brokers.sendOnboardingReminder.useMutation({
              ...
              <CardContent className="p-5">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex justify-between mt-3">
                    {["Application", "Documents", "Verification", "Review", "Complete"].map((step: any, idx: number) => {
                      const stepNum = idx + 1;
